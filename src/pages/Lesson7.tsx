    ...
    <div>
      <AppWrapper section={HeaderSections.LESSON_7}>
        <div className="page-wrapper">
          ...
          <p>
            Let's talk about arrays, since they are helpful for understanding
            pointer arithmetic! Arrays are typically used to represent multiple
            values of the same type in one data structure. In memory, arrays are
            represented by just having values set contiguously in memory. This
            means that we can simply add to our pointer to move the pointer to.
          </p>

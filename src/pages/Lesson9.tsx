      ...
      <AppWrapper section={HeaderSections.LESSON_9}>
        <div className="page-wrapper">
          ...
          <p>
            ...
            <strong> doubly linked lists </strong>. Doubly linked lists also
            have a pointer that goes backwards through the list. See this
            example of tracing a linked list through the tail pointer, a pointer
          ...
          <div className="diagram">
            <Note title="Note: What is nullptr">
              <p>
                <strong>nullptr </strong>in C++ is the null pointer. In C++ it
                actually has a different meaning from <strong>NULL</strong>{' '}
                (which is actually equal to 0). It is a keyword that
                specifically means that a pointer does not point to anything, so
                generally you should use nullptr when dealing with pointers. If
                a nullptr is <strong>dereferenced</strong>, it is{' '}
                <strong>undefined behavior</strong> and most of the time your
                program will hang (never finish execution).
              </p>
            </Note>
          </div>

      ...
      <AppWrapper section={HeaderSections.EXERCISE_4}>
        <div className="page-wrapper">
          ...
          <p>
            ...
            address spaces to get there from their current position. In order to access
            box b, pipi must move the pointer to it using pointer arithmetic.
          </p>
          <h2>
          ...
          <h2>How can we move the pointer to the address that box b contains?</h2>
          ...
          <p>
          By going from box to box, we can see how it is not too hard to access
          these boxes in one dimension, but let’s see now how we can access them
          in multiple dimensions!
          </p>

          <p>
          Pipi is back on the top shelf of the warehouse and has multiple rows of
          boxes to get to! As we know, multi-dimensional arrays are actually the same
          things as 1-dimensional arrays in memory, it is just how we access them that
          is different!
          </p>
          ...
          <h2>How can we move the pointer to the address of box m and dereference it?</h2>

          <p>
          Note that with multi-dimensional arrays, we can only use the bracket syntax multiple
          times if the array was declared as a multidimensional array and not a single dimensional
          array because otherwise, the program would not know the width of each row!
          </p>
        </div>

    ...
    <>
      <AppWrapper section={HeaderSections.LESSON_3}>
        <div className="page-wrapper">
          ...
          <p>
            If you put & in front of any variable, it will return the memory
            address of that variable. And now that it has returned a value, you
            can treat it just like any other value by assigning it to a
            variable. You can assign this address value to a pointer variable
            like this:
          </p>
          <div className="diagram">terminal 3</div>
          <p>
            In the above code, myPointer will now store the address of
            myVariable:
          </p>
          ...
          <h2>Note</h2>
          <p>
            If you try to print out the value of a memory address using cout,
            you might see that the value looks something like 0x7ffde45c9a54
          </p>
          <p>
            ...
            that this is a hexadecimal number because the address begins with 0x
            at the front, and among the numbers you will also find the letters
            a-f. You&apos;ll learn more about this in a later class!
          </p>

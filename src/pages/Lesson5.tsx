      ...
      <AppWrapper section={HeaderSections.LESSON_5}>
        <div className="page-wrapper">
          ...
          <p>
            ...
            myVariable, and we give it a value of 3. In the next line, we create
            a pointer that stores the memory address of myVariable - myPointer
            now points to myVariable. The third line is where things get
            interesting. This is basically saying that we go to the value stored
            at the address in myPointer, and we set that value equal to 5. Just
            like when we reassign a normal variable to a new value, when we
            reassign the value stored at a memory address we overwrite the
            previous value and it now just contains the new value. Click through
            each line of code to see how the diagram changes
          </p>
